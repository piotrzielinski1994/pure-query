...
// The selectable rows (folders + databases) in visible DFS order: a folder's
// children are listed only when the folder is expanded; tables are never
// selectable. This order is what shift-click ranges over.
